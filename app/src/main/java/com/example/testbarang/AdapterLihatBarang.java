...
//public class AdapterLihatBarang extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_adapter_lihat_barang);
//    }
//}
...
public class AdapterLihatBarang extends
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
         ...
         * Inisiasi ViewHolder
         */
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_barang,
                parent, false);
